    ...
    def run_all(self, conf_file):
        ...
        for vip in ssl_vip:
            ...
            try:    
                ...
                max_conn = "-"
                avg_conn = "-"
            ssl_info = {"vip_name": vip[0], "vip_address": vip[1], "bit": bit, "cert_expiration_date": not_after, "days_to_expire": days_to_expire, "average_connection": avg_conn, "max_connection": max_conn}
            ssl.append(ssl_info)
        self.data["ssl"] = ssl
